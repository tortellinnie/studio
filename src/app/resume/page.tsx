          ...
          <div className="max-w-[8.5in] mx-auto">
            ...
            <div className="bg-white text-black shadow-2xl p-[0.75in] font-serif leading-tight print:shadow-none print:p-0 min-h-[11in] mx-auto border border-slate-200 print:border-none">
              ...
              <div className="text-center mb-6">
                <h1 className="text-4xl font-bold uppercase tracking-tight mb-1">SHANN KARL FELIPE</h1>
                ...
                <div className="text-[10pt] mt-1 font-medium">
              ...
              {/* Summary */}
              <div className="mb-4">
                <h2 className="text-[11pt] font-bold border-b border-black uppercase mb-1 tracking-widest">Summary</h2>
              ...
              {/* Technical Skills */}
              <div className="mb-4">
                <h2 className="text-[11pt] font-bold border-b border-black uppercase mb-1 tracking-widest">Technical Skills</h2>
              ...
              {/* Experience */}
              <div className="mb-4">
                <h2 className="text-[11pt] font-bold border-b border-black uppercase mb-1 tracking-widest">Experience</h2>
              ...
              {/* Projects */}
              <div className="mb-4">
                <h2 className="text-[11pt] font-bold border-b border-black uppercase mb-1 tracking-widest">Projects</h2>
                ...
                <div className="mb-3">
                  ...
                  <div className="text-[9pt] italic mb-1">(Docker, n8n, ngrok, Google Cloud APIs, Gemini AI)</div>
                  <ul className="list-disc list-outside ml-5 text-[10pt] mt-1 space-y-0.5">
              ...
              {/* Education */}
              <div className="mb-4">
                <h2 className="text-[11pt] font-bold border-b border-black uppercase mb-1 tracking-widest">Education</h2>
                <div className="flex justify-between items-baseline">
              ...
              {/* Awards */}
              <div className="mb-2">
                <h2 className="text-[11pt] font-bold border-b border-black uppercase mb-1 tracking-widest">Awards</h2>
