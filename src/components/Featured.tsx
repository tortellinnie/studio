          ...
          {highlights.map((item) => {
            ...
            return (
              <Link href={`/impact/${item.id}`} key={item.id} className="group">
                <Card className="glass-card border-white/5 overflow-hidden transition-all duration-500 hover:border-primary/40 hover:-translate-y-2 h-full flex flex-col">
                  ...
                  <CardContent className="p-12 space-y-8 flex-grow">
