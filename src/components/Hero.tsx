        ...
        <div className="space-y-12 w-full max-w-screen-xl">
          <div className="space-y-8">
            ...
            <div className="overflow-hidden py-4">
              <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-9xl font-black text-white leading-none tracking-tighter animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200 uppercase whitespace-nowrap">
