          ...
          <div className="order-2 flex justify-center lg:justify-end animate-in fade-in slide-in-from-right-12 duration-1000 delay-200 overflow-visible">
            {profileImage && (
              <div className="relative w-full max-w-[380px] aspect-[3/4] group overflow-visible">
                ...
                {/* AI Automation Badge anchored lower left, halfway off the edge */}
                <div className="absolute bottom-4 -left-16 animate-float z-20 overflow-visible">
                  <div className="px-5 py-3 rounded-[1.5rem] bg-white/[0.03] backdrop-blur-2xl border border-white/5 shadow-2xl flex flex-col items-start gap-0.5 hover:bg-white/8 transition-all cursor-default scale-110">
                    ...
                    <span className="text-[8px] font-black text-white/40 uppercase tracking-widest whitespace-nowrap">Automation</span>
                  </div>
                </div>
              </div>
            )}
