            ...
            {projects.map((project) => {
              ...
              return (
                <Link href={`/projects/${project.id}`} key={project.id} className="group">
                  <Card className="glass-card overflow-hidden border-white/10 transition-all duration-500 hover:-translate-y-2 h-full flex flex-col rounded-[2.5rem]">
                    <div className="relative aspect-video overflow-hidden">
                      ...
                      <div className="absolute bottom-4 left-6 w-12 h-12 rounded-xl bg-primary/20 backdrop-blur-md border border-primary/20 flex items-center justify-center">
                    ...
                    <div className="p-8 flex-grow flex flex-col">
                      ...
                      <CardFooter className="p-0 pt-8">
                         <span className="text-sm font-black text-primary group-hover:underline decoration-2 underline-offset-8 uppercase tracking-widest">
                            View Detail
                         </span>
                      </CardFooter>
                    </div>
