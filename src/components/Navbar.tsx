  ...
  return (
    <nav className="fixed top-0 z-[100] w-full pt-6">
      <div className="container mx-auto px-6">
        <div className="h-20 glass-card rounded-[2rem] px-8 flex items-center justify-between border-white/[0.08] shadow-2xl">
          <Link href="/" className="text-xl md:text-2xl font-headline font-black tracking-tighter hover:scale-105 transition-transform group shrink-0">
